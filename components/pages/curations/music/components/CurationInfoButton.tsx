    ...
    >
      ...
      >
        <div>
          ...
          <div style={{ paddingTop: 2, fontSize: 14 }}>
            guadalajara, jalisco
          </div>
        </div>
        <div
        ...
        <div style={{ display: "flex", flexDirection: "row", paddingTop: 16 }}>
          ...
          <div className={styles.socialIconContainer}>
            <a
              href={"https://github.com/clumsycomputer"}
              rel={"noreferrer"}
              target={"_blank"}
              onClick={() => {
                setInfoDisplay(null);
          ...
          <div className={styles.socialIconContainer}>
            <a
              href={"https://twitter.com/c1umsyc0mputer"}
              rel={"noreferrer"}
              target={"_blank"}
              onClick={() => {
                setInfoDisplay(null);
